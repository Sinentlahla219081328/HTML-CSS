...
# CSS
style bg color, text color,text align,font size , font weight,font family"font name",set text to be uppercase using text transform, use span element add a class to style one line of a paragraph.
